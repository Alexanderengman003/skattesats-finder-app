      ...
      <Table>
        <TableHeader className="sticky top-0 bg-white z-10">
          <TableRow className="bg-blue-50">
            ...
            <TableHead className="font-semibold text-blue-900 text-center">Kommunkod</TableHead>
            <TableHead className="font-semibold text-blue-900 text-center">Skattesats (%)</TableHead>
            <TableHead className="font-semibold text-blue-900 text-center">År</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
